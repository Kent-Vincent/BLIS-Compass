...
import { GraduationCap, ShieldCheck, ArrowRight, Loader2, Compass, Send, Eye, EyeOff } from 'lucide-react';
...
const IndexEntry: React.FC = () => {
  ...
  if (session && profile) {
    ...
    // Do nothing yet when session exists but profile is still loading
